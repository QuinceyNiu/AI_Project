...
# train:test:val = 5:3:2
trainval_percent = 0.7  # 70% for training and validation sets
train_percent = 5/7  # Approximately 0.714, training is 5 out of 7 parts of the trainval set
